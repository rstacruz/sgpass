...
# == Common usage
#
#   SGPass.generate('password', 'facebook.com')
#
#   # Specified length
#   SGPass.generate('password', 'facebook.com', length: 12)
#
#   # Disable subdomain retrieval
#   SGPass.generate('password', 'facebook.com', tld: false)
#
module SGPass
  ...
  def self.generate(password, domain, options={})
    ...
    i = 0
    while i < 10 || !strong_enough?(str[0...length])
      str = b64_md5(str)
      i += 1
    end
